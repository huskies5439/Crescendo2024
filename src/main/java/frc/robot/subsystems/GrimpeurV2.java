...
public class GrimpeurV2 extends SubsystemBase {
  ...
  public Command monter(){
    return new StartEndCommand(()-> this.setVoltage(true), this::stop, this).until(this::maxHauteur);
  }

  public Command descendre(){
    return new StartEndCommand(()-> this.setVoltage(false), this::stop, this).until(this::minHauteur);
  }
